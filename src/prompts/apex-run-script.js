...
export const apexRunScriptPromptDefinition = {
	title: 'Apex run script',
	description: 'Apex run script',
	argsSchema: {
...
export function apexRunScriptPrompt({currentBehavior, desiredBehavior, updateTests}) {
	return {
		messages: [
			{
				role: 'user',
